...
//
// Default FTS configuration values can be changed here. Please refer to the
// FTS specification for a full description of the fields and value meanings
//

static FTS_CONFIGURATION gDefaultConfiguration =
{
    //
    // FTS F01 - Device control settings
    //
    {
        0,                                              // Sleep Mode (normal)
        1,                                              // No Sleep (do sleep)
        ...
        FTS_MILLISECONDS_TO_TENTH_MILLISECONDS(20),    // Doze Interval
        10,                                             // Doze Threshold
        FTS_SECONDS_TO_HALF_SECONDS(2)                 // Doze Holdoff
    },

    //
    // FTS F11 - 2D Touchpad sensor settings
    //
    {
