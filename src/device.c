...
/*++
  ...
  Routine Description:
	...
	level-triggered interrupts when using ST 3202.
...
*/
{
	...
	//
	// N.B. This FTS chip's IRQ is level-triggered, but cannot be enabled in
...
--*/
{
	...
	//
	// Configure the timer for continuous simulation on st hardware that doesn't support it
	//
